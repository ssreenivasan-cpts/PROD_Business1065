...
public class OverviewpgPO {
	...
	By preparertab = By.xpath("//p[contains(text(),'preparers')]");
	By qaViewbtnfor334 = By.xpath("//button[@id='btnViewOfficeList0']");//view btn for first office//FIRST_OFFICE_ID
	By qaViewbtnfor333 = By.xpath("//button[@id='btnViewOfficeList14']");//view btn for republic office 333
	By qaViewbtnfor528 = By.id("btnViewOfficeList2");//view btn for 528-BUSscripts
	...
	By qaViewprepbtnfor333 = By.id("btnViewPreparerLoginID452");
	By qaViewprepbtnfor00saran=By.id("btnViewPreparerLoginID1704");//view btn for 00saran-BUSscripts
	...
	By taxreturnsbtn =By.xpath("//p[contains(text(),'tax returns')]"); //tax returns btn in side bar
	By Newtaxreturnbtn = By.id("addReturnButton"); //add a new return button
	By firstTaxRtrnOpenbtn = By.id("btnOpenTaxReturnTRList0");//1streturn in Taxreturns
	By invoicebillinggobtn = By.id("btnOpenReturnAtGeneralVarUSIN01");//Go btn for billing in TR
	...
	By calendarbtn = By.id("btnSideBar6");//appointment icon left menu
	...
	//------------------------------------------Messages-------------------------------------------------------
	By notificonbtn = By.id("btnSideBar7");//Notifications icon in the left menu //secure messages
	...
	//-------------------------------------Checks----------------------------------------------
	By chksiconbtn = By.id("btnSideBar10");//checks icon button on the left menu
	...
	//-----------------Search
	By searchbtn = By.id("txtSearchValueSearchBar");
	...
	//---------- Tax Return Tab
	By openfirsttaxretrn = By.id("btnOpenTaxReturnTRList-0");
	...
	By Businesstabinprep = By.xpath("//span[contains(text(),'BUSINESS')]"); //inside a preparer
	By Bus_newreturm_ein = By.name("ein");//c
	By Bus_newreturn_confirmein = By.name("einConfirm");
	By Bus_newreturn_radiobtn1065 = By.id("1065-1");
	By Bus_newreturn_radiobtn1120s = By.id("1120S-2");
	By Bus_newreurn_radiobtn1120 = By.id("1120-3");
	By Bus_newreturn_Create = By.id("createBusinessReturnBtn");
	...
	public WebElement clickqaViewbtnfor528()
	{
		return driver.findElement(qaViewbtnfor528);
	}
	...
	public WebElement clickqaViewprepbtnfor00saran()
	{
		return driver.findElement(qaViewprepbtnfor00saran);
	}
	...
	public WebElement clickfirstTaxRtrnOpenbtn()
	{
		return driver.findElement(firstTaxRtrnOpenbtn);
	}
	public WebElement clickinvoicebillinggobtn()
	{
		return driver.findElement(invoicebillinggobtn);
	}
...
//--------------------------------------------------------------------------------------------
	...
	public WebElement clickBusinesstabinprep()
	{
		return driver.findElement(Businesstabinprep);
	}
	public WebElement getBus_newreturn_ein()
	{
		return driver.findElement(Bus_newreturm_ein);
	}
	public WebElement getBus_newreturn_confirmein()
	{
		return driver.findElement(Bus_newreturn_confirmein);
	}
	public WebElement clickBus_newreturn_radiobtn1065()
	{
		return driver.findElement(Bus_newreturn_radiobtn1065);
	}
	public WebElement clickBus_newreturn_radiobtn1120s()
	{
		return driver.findElement( Bus_newreturn_radiobtn1120s);
	}
	public WebElement clickBus_newreurn_radiobtn1120()
	{
		return driver.findElement(Bus_newreurn_radiobtn1120);
	}
	
	public WebElement clickBus_newreturn_Create()
	{
		return driver.findElement(Bus_newreturn_Create);
	}
